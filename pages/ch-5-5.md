...
<ThemeTitle number="5" class="text-7xl! leading-20!">
<div>組件的記憶化</div>
<div>React.memo</div>
</ThemeTitle>
...
[click]
就像以下程式碼， 如果我們不想要每次 Re-render 都導致 Child 重新運算，就可以使用 React.memo 來記憶化整個組件：
...
[click]
比如在這個例子中，onClick 與 data 都透過 useCallback 和 useMemo 做記憶化，因此在 count 改變時，兩者的參考值都不會改變，MemoChild 就能成功地被記憶起來。
-->
